...
export function MainNav({ className, display }: MainNavProps) {
  ...
  const navItems = [
    ...
    {
      name: "Bookings",
      href: `/admin/stores/${storeId}/appointments`,
      icon: IoIosBook,
    },
    {
      name: "Service",
      href: `/admin/stores/${storeId}/service`,
      icon: IoIosApps,
    },
    {
      name: "Customers",
    ...
    {
      name: "Design Online Pages",
      href: `/admin/stores/${storeId}/design`,
      icon: IoIosApps,
    },
    {
      name: "Settings",
  ...
  return (
    <nav
      className={cn(
        ...
        display === "coloumn"
          ? "flex-col gap-y-3"
          : "flex-row items-center space-x-4 lg:space-x-6"
      )}
    >
      {navItems.map((item) => (
        <Link
          ...
          className={cn(
            ...
            pathname === item.href
              ? "bg-slate-50 text-slate-900 dark:bg-slate-800 dark:text-slate-300 px-1.5"
              : ""
          )}
        >
